  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.progressBarContainer}>
        <View style={[styles.progressBar, { backgroundColor: currentTheme === 'light' ? Colors.lightGray : Colors.mediumGray }]}>
          <Animated.View 
            style={[
              styles.progressFill, 
              { 
        ...
        <Text style={[styles.progressText, { color: currentTheme === 'light' ? Colors.accent : Colors.lightGray }]}>
